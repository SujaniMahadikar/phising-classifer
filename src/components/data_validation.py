...
class DataValidation:
    ...
    def validate_file_name(
        self, file_path: str, length_of_date_stamp: int, length_of_time_stamp: int
    ) -> bool:
        """
        ...
        try:
            ...
            if re.match(regex, file_name):
                ...
                filename_validation_status = (
                    len(splitAtDot[1]) == length_of_date_stamp
                    and len(splitAtDot[2]) == length_of_time_stamp
                )
            else:
    ...
    def validate_no_of_columns(self, file_path: str, schema_no_of_columns: int) -> bool:
        ...
        try:
            ...
            column_length_validation_status = (
                len(dataframe.columns) == schema_no_of_columns
            )
    ...
    def validate_raw_files(self) -> bool:
        ...
        try:
            ...
            length_of_date_stamp, length_of_time_stamp, column_names, no_of_column = (
                self.valuesFromSchema()
            )
            ...
            for raw_file_path in raw_batch_files_paths:
                ...
                column_length_validation_status = self.validate_no_of_columns(
                    raw_file_path, schema_no_of_columns=no_of_column
                )

                missing_value_validation_status = (
                    self.validate_missing_values_in_whole_column(raw_file_path)
                )
